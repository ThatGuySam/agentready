...
| ----------- | ------------------------------------------ | ------ | ------------------------ | ----------- | --------- |
| robots.txt  | [URL](https://docs.cursor.com/robots.txt)  | 200    | text/html; charset=utf-8 | status only | no        |
| sitemap.xml | [URL](https://docs.cursor.com/sitemap.xml) | 200    | text/html; charset=utf-8 | status only | no        |
| llms.txt    | [URL](https://docs.cursor.com/llms.txt)    | 200    | text/html; charset=utf-8 | status only | no        |
