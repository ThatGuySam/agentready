...
To try using Git yourself, see [Getting started with Git](/en/get-started/learning-to-code/getting-started-with-git).
...
If you're new to GitHub, and unfamiliar with Git, we recommend working through the articles in the [Start your journey](/en/get-started/start-your-journey) category. The articles focus on tasks you can complete directly in your browser on GitHub and will help you to:
