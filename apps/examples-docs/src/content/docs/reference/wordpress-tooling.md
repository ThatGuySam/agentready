...
- **WordPress core:** use `Settings -> Reading`, `Settings -> Permalinks`,
  ...
  `Posts`.
- **Yoast, if it is already installed:** use
  `Yoast SEO -> Settings -> Site features -> llms.txt` and
  `Yoast SEO -> Tools -> File editor`; keep one sitemap/schema owner.
...
- **Custom Plugins:** Roll exactly what you need using official
  [WP Agent Skills](https://github.com/wordPress/agent-skills) and Codeable
...
- **Tiny custom plugin, mu-plugin, static file, or deploy step:** root files and
  ...
  expose cleanly. For custom plugins, roll exactly what you need using official
  [WP Agent Skills](https://github.com/wordPress/agent-skills) and Codeable
  Agent Coding standards.
...
3. **A tiny custom plugin or mu-plugin** for a site-specific `robots_txt` filter,
   root-file generation, or controlled endpoint. Roll exactly what you need
   using official [WP Agent Skills](https://github.com/wordPress/agent-skills)
   and Codeable Agent Coding standards.
...
- [WP Agent Skills](https://github.com/wordPress/agent-skills)
