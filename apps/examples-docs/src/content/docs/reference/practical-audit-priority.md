...
<section class="bluf-summary" role="radiogroup" aria-label="Page summary">
  <div class="bluf-summary__item">
    <input class="bluf-summary__control" type="radio" name="practical-audit-bluf" id="practical-audit-bluf-bottom-line" checked />
    <label class="bluf-summary__summary" for="practical-audit-bluf-bottom-line">Bottom line</label>
  ...
  <div class="bluf-summary__item">
    <input class="bluf-summary__control" type="radio" name="practical-audit-bluf" id="practical-audit-bluf-relevance" />
    <label class="bluf-summary__summary" for="practical-audit-bluf-relevance">Is this relevant?</label>
    <div class="bluf-summary__panel">
      <div class="bluf-summary__panel-inner">
